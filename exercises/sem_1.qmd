...
8. Utilisez l'addin RStudio 'ggplot2 builder'. L'objectif est de tracer les musées selon leurs coordonnées géographiques. La couleur du point traduira si le musée est toujours ouvert aujourd'hui, et la forme du point traduira le type de gouvernance du musée. Exportez le code depuis l'addin.
9. Modifiez le code généré pour tracer en fond les contours du Royaume-uni.
