...
-   [targets package](https://docs.ropensci.org/targets/) Documentation du package `targets`.
-   [2018 - targets tutorial](https://github.com/wlandau/targets-tutorial) Un tuto `targets` qui date de 2018 - mais toujours valide dans les grandes lignes.
-   [targets manual](https://books.ropensci.org/targets/) Manuel avancé de `targets`.
